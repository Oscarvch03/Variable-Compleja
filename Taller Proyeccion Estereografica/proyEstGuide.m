...
% Last Modified by GUIDE v2.5 24-Feb-2020 15:05:50
...
% --- Executes on button press in GrafAndProyec.
function GrafAndProyec_Callback(hObject, eventdata, handles)
% hObject    handle to GrafAndProyec (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)


% --- Executes on button press in UnirProyPuntos.
function UnirProyPuntos_Callback(hObject, eventdata, handles)
% hObject    handle to UnirProyPuntos (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
